...
DROP TABLE IF EXISTS `depreciation_accounts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `depreciation_accounts` (
  `depreciation_account_id` int(11) NOT NULL AUTO_INCREMENT,
  `depreciation_account_name` varchar(200) NOT NULL,
  `depreciation_account_type` varchar(200) NOT NULL,
  `depreciation_account_balance` decimal(15,2) NOT NULL DEFAULT 0.00,
  `depreciation_account_currency_code` varchar(200) NOT NULL,
  `depreciation_account_notes` text DEFAULT NULL,
  `depreciation_account_created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `depreciation_account_updated_at` datetime DEFAULT NULL ON UPDATE current_timestamp(),
  `depreciation_account_archived_at` datetime DEFAULT NULL,
  PRIMARY KEY (`depreciation_account_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `expenses` (
  ...
  `expense_tax` decimal(15,2) NOT NULL DEFAULT 0.00,
  `expense_tax_id` int(11) NOT NULL DEFAULT 0,
  ...
  `expense_lifetime` int(11) NOT NULL DEFAULT 0,
  `expense_current_value` int(11) NOT NULL DEFAULT 0,
  `expense_depreciation_annually` int(11) NOT NULL DEFAULT 0,
...
CREATE TABLE `revenues` (
  ...
  `revenue_net_profit` decimal(15,2) NOT NULL DEFAULT 0.00,
  ...
  `revenue_tax` decimal(15,2) NOT NULL DEFAULT 0.00,
  `revenue_tax_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `date_configurations`
--

DROP TABLE IF EXISTS `date_configurations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `date_configurations`(
  `date_configuration_id` int(11) NOT NULL AUTO_INCREMENT,
  `date_configuration_name` varchar(200) NOT NULL,
  `date_configuration_start_day` int(2),
  `date_configuration_start_month` int(2),
  `date_configuration_end_day` int(2),
  `date_configuration_end_month` int(2),
  `date_configuration_created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `date_configuration_updated_at` datetime NOT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`date_configuration_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
