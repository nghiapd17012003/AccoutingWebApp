<div class="modal" id="addDepreciationAccountModal" tabindex="-1">
        ...
        <div class="modal-content bg-dark">
            ...
            <form action="post.php" method="post" autocomplete="off">
                ...
                <div class="modal-footer bg-white">
                    <button type="submit" name="add_depreciation_account" class="btn btn-primary text-bold"><i class="fa fa-check mr-2"></i>Create</button>
