        ...
        <div class="table-responsive-sm">
            <table class="table table-striped table-borderless table-hover">
                ...
                <tr>
                    ...
                    <th><a class="text-dark" href="?<?php echo $url_query_strings_sb; ?>&sb=revenue_tax_type&o=<?php echo $disp; ?>">Tax</a></th>
                    <th class="text-right"><a class="text-dark" href="?<?php echo $url_query_strings_sb; ?>&sb=revenue_tax&o=<?php echo $disp; ?>">Tax Amount</a></th>
                    <th class="text-right"><a class="text-dark" href="?<?php echo $url_query_strings_sb; ?>&sb=revenue_amount&o=<?php echo $disp; ?>">Amount(inc Tax)</a></th>
                    <th class="text-right"><a class="text-dark" href="?<?php echo $url_query_strings_sb; ?>&sb=revenue_net_profit&o=<?php echo $disp; ?>">Net Amount</a></th>
                ...
                while ($row = mysqli_fetch_array($sql)) {
                    ...
                    $revenue_net_profit = floatval($row['revenue_net_profit']);
                    $revenue_tax = floatval($row['revenue_tax']);
                    $tax_id = intval($row['tax_id']);
                    $tax_name = htmlentities($row['tax_name']);
                    $tax_percent = floatval($row['tax_percent']);
                    $tax_type = $tax_name . ' ' . $tax_percent . '%';
		    ...
		    <tr>
                        ...
                        <td class="text-bold text-right"><?php echo numfmt_format_currency($currency_format, $revenue_tax, $revenue_currency_code); ?></td>
                        <td class="text-bold text-right"><?php echo numfmt_format_currency($currency_format, $revenue_amount, $revenue_currency_code); ?></td>
                        <td class="text-bold text-right"><?php echo numfmt_format_currency($currency_format, $revenue_net_profit, $revenue_currency_code); ?></td>
