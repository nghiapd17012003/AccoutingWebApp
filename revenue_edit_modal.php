    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content bg-dark">
			...
			<div class="form-group col-md">
                            ...
                            <div class="input-group">
                                <select class="form-control select2" name="revenue_tax_id" required>
					<?php

                                    $sql_taxes = mysqli_query($mysqli, "SELECT tax_id, tax_name, tax_percent FROM taxes WHERE (tax_archived_at > '$revenue_created_at' OR tax_archived_at IS NULL) ORDER BY tax_name ASC");
                                    while ($row = mysqli_fetch_array($sql_taxes)) {
                                        ...
                                        ?>
                                        <option <?php if ($revenue_tax_id == $tax_id_select) { ?> selected <?php } ?> value="<?php echo $tax_id_select; ?>"><?php echo $tax_name_select.' '. $tax_percent_select.'%'; ?></option>
                                        <?php
                                    }
