...
$sql_expense_years = mysqli_query($mysqli, "SELECT DISTINCT YEAR(expense_date) AS expense_year, MONTH(expense_date) as expense_month FROM expenses ORDER BY expense_year DESC");
